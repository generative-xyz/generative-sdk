...
const createRawCommitTx = ({ internalPubKey, data, utxos, feeRatePerByte, reImbursementTCAddress, hashLockKeyPair, hashLockRedeem, hashLockScript, script_p2tr, revealVByte, }) => {
    ...
    for (let nTry = 0; nTry < 100; nTry++) {
        ...
        const p2pk_psbt = new bitcoinjsLib.Psbt({ network });
...
const createRawRevealTx = ({ internalPubKey, feeRatePerByte, commitTxID, hashLockKeyPair, hashLockRedeem, script_p2tr, revealVByte }) => {
...
const createInscribeTx = ({ senderPrivateKey, utxos, inscriptions, data, reImbursementTCAddress, feeRatePerByte, }) => {
    ...
    selectCardinalUTXOs(utxos, inscriptions, totalAmount);
