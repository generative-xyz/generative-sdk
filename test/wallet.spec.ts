...
import { decryptWallet, deriveETHWallet, derivePasswordWallet, deriveSegwitWallet, encryptWallet, getBitcoinKeySignContent, importBTCPrivateKey, signByETHPrivKey, Wallet } from "../src/index";
...
describe("Import Wallet", async () => {
    ...
    it("Import BTC private key - derive eth wallet and sign by eth private key", async () => {
        ...
        signByETHPrivKey(ethPrivKey, toSign);
    });
});
