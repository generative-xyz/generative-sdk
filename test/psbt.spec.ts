import { createPSBTToSell, createPSBTToBuy, UTXO, network, convertPrivateKeyFromStr, convertPrivateKey, reqListForSaleInscription, reqBuyInscription } from "../dist/index";
...
describe("Buy and Sell inscription with PSBT", () => {
    it("feePayToCreator > 0: seller split UTXO first", async () => {
        ...
        const { txID, txHex, fee, selectedUTXOs: selectedUTXOsBuyer, changeAmount } = await reqBuyInscription({
        ...
        console.log("Final TxID TX hex: ", txID, txHex);
